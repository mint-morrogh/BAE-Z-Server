...
set "CUSTOM_MODS=@MinimapTweak;@HUDClock;@StackableItems;@MWGSM_TraderFix;@BAEZLoadingScreen;@EnableInventoryInVehicle;@InventoryMoveSoundsFix;@TraderSearchFix"
...
call :sync_mod InventoryMoveSoundsFix
call :sync_mod TraderSearchFix
